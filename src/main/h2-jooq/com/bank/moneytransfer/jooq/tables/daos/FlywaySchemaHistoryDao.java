...
public class FlywaySchemaHistoryDao extends DAOImpl<FlywaySchemaHistoryRecord, com.bank.moneytransfer.jooq.tables.pojos.FlywaySchemaHistory, Integer> {

    /**
     * Create a new FlywaySchemaHistoryDao without any configuration
     */
    public FlywaySchemaHistoryDao() {
        super(FlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY, com.bank.moneytransfer.jooq.tables.pojos.FlywaySchemaHistory.class);
    }
    ...
    public FlywaySchemaHistoryDao(Configuration configuration) {
        super(FlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY, com.bank.moneytransfer.jooq.tables.pojos.FlywaySchemaHistory.class, configuration);
    }

    @Override
    public Integer getId(com.bank.moneytransfer.jooq.tables.pojos.FlywaySchemaHistory object) {
     ...
     */
    public List<com.bank.moneytransfer.jooq.tables.pojos.FlywaySchemaHistory> fetchRangeOfInstalledRank(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.bank.moneytransfer.jooq.tables.pojos.FlywaySchemaHistory> fetchByInstalledRank(Integer... values) {
     ...
     */
    public com.bank.moneytransfer.jooq.tables.pojos.FlywaySchemaHistory fetchOneByInstalledRank(Integer value) {
     ...
     */
    public List<com.bank.moneytransfer.jooq.tables.pojos.FlywaySchemaHistory> fetchRangeOfVersion(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.bank.moneytransfer.jooq.tables.pojos.FlywaySchemaHistory> fetchByVersion(String... values) {
     ...
     */
    public List<com.bank.moneytransfer.jooq.tables.pojos.FlywaySchemaHistory> fetchRangeOfDescription(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.bank.moneytransfer.jooq.tables.pojos.FlywaySchemaHistory> fetchByDescription(String... values) {
     ...
     */
    public List<com.bank.moneytransfer.jooq.tables.pojos.FlywaySchemaHistory> fetchRangeOfType(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.bank.moneytransfer.jooq.tables.pojos.FlywaySchemaHistory> fetchByType(String... values) {
     ...
     */
    public List<com.bank.moneytransfer.jooq.tables.pojos.FlywaySchemaHistory> fetchRangeOfScript(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.bank.moneytransfer.jooq.tables.pojos.FlywaySchemaHistory> fetchByScript(String... values) {
     ...
     */
    public List<com.bank.moneytransfer.jooq.tables.pojos.FlywaySchemaHistory> fetchRangeOfChecksum(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.bank.moneytransfer.jooq.tables.pojos.FlywaySchemaHistory> fetchByChecksum(Integer... values) {
     ...
     */
    public List<com.bank.moneytransfer.jooq.tables.pojos.FlywaySchemaHistory> fetchRangeOfInstalledBy(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.bank.moneytransfer.jooq.tables.pojos.FlywaySchemaHistory> fetchByInstalledBy(String... values) {
     ...
     */
    public List<com.bank.moneytransfer.jooq.tables.pojos.FlywaySchemaHistory> fetchRangeOfInstalledOn(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<com.bank.moneytransfer.jooq.tables.pojos.FlywaySchemaHistory> fetchByInstalledOn(LocalDateTime... values) {
     ...
     */
    public List<com.bank.moneytransfer.jooq.tables.pojos.FlywaySchemaHistory> fetchRangeOfExecutionTime(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.bank.moneytransfer.jooq.tables.pojos.FlywaySchemaHistory> fetchByExecutionTime(Integer... values) {
     ...
     */
    public List<com.bank.moneytransfer.jooq.tables.pojos.FlywaySchemaHistory> fetchRangeOfSuccess(Boolean lowerInclusive, Boolean upperInclusive) {
     ...
     */
    public List<com.bank.moneytransfer.jooq.tables.pojos.FlywaySchemaHistory> fetchBySuccess(Boolean... values) {
